module flower {
	export class StringValue extends flower.Value {
		private _events:Array<any>;
		private _value:any = "";

		public constructor(initValue:any = "")
		{
			super();
			if(initValue)
			{
		...
		public static pool:Array<flower.StringValue>;
		public static create(initValue:any = null):flower.StringValue
		{
			var value:flower.StringValue;
			if(flower.StringValue.pool.length)
			{
				value = flower.StringValue.pool.pop();
				value._events = [];
				value._value = "" + initValue;
			}
			else
			{
				value = new flower.StringValue(initValue);
			}
			return value;
		}

		public static release(value:flower.StringValue)
		{
			value.dispose();
			flower.StringValue.pool.push(value);
		}

	}
}

flower.StringValue.pool = new Array<flower.StringValue>();
