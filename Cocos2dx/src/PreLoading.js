...
var PreLoading = function (_flower$EventDispatch) {
    ...
    function PreLoading() {
        ...
        _this.modules = [new flower.Module("modules/software/module.json"), new flower.Module("modules/gameEditor/module.json"), new flower.Module("modules/dungeonEditor/module.json")];
